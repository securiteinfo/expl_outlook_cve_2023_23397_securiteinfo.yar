rule SUSP_EXPL_Msg_CVE_2023_23397_Mar23_securiteinfo {
   meta:
      description = "MSG file with a PidLidReminderFileParameter property, potentially exploiting CVE-2023-23397"
      author = "delivr.to, modified by Florian Roth, Nils Kuhnert, Arnim Rupp, marcin@ulikowski.pl, securiteinfo.com"
      date = "2023-03-15"
      modified = "2023-03-17"
      score = 60
...
rule EXPL_SUSP_Outlook_CVE_2023_23397_Exfil_IP_Mar23_securiteinfo {
   meta:
      ...
      author = "delivr.to, Florian Roth, Nils Kuhnert, Arnim Rupp, marcin@ulikowski.pl, modified by securiteinfo.com"
      date = "2023-03-15"
      modified = "2023-03-18"
      score = 75
      reference = "https://www.mdsec.co.uk/2023/03/exploiting-cve-2023-23397-microsoft-outlook-elevation-of-privilege-vulnerability/"
...
rule EXPL_SUSP_Outlook_CVE_2023_23397_SMTP_Mail_Mar23_securiteinfo {
   meta:
      author = "Nils Kuhnert, modified by securiteinfo.com"
      date = "2023-03-17"
   ...
   strings:
	...
	$tnef2 = "XHg3OFx4OWZceDNlXHgyMg" nocase

      // Check if it's an IPM.Task
      //$ipm = "IPM.Task" base64
	$ipm = "SVBNLlRhc2s" nocase

      // UNC prefix in TNEF
      //$unc = "\x00\x00\x00\x5c\x5c" base64
	$unc = "XHgwMFx4MDBceDAwXHg1Y1x4NWM" nocase
   condition:
      all of them
}
